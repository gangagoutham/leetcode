...
public class TestCases {
    ...
    public  void testCase01(){
        ...
        if(currentURL.contains("leetcode")){
            System.out.println(" The URL contains leetcode");
        }else{
            System.out.println(" The URL does not contain leetcode");
        }
    ...
    if(currentUrl.contains("two-sum")){
        System.out.println("URL verification passed: 'two-sum' is in the URL");
    }else{
        System.out.println("URL verification failed: 'two-sum' is in the URL");
    }
    } catch (Exception e) {
